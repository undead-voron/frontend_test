<template>
  <div class="flex h-screen flex-col items-center justify-center bg-brand-primary bg-cover">
    <header class="flex w-full shrink-0 items-center justify-center bg-gray-900 p-2 text-center">
